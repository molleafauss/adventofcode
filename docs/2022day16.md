...
Seems we're heading in the right direction. Let's stop optimising python, the language is anyway 
interpreted so any effort with the sheer amount of operations the algorithm requires can't 
