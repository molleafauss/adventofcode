...
a further improvement. We might be in the lan of diminishing returns anyway.
...
- Python didn't see any particular improvement. We haven't committed any optimisation as the 
    interpreted nature of the language, limits gains by using a different memory model.
