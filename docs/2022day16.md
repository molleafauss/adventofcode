...
|----------|---------------|---------------------|-------------|
| Python   | 414.8sec      | avg & peak 100%     | 16GB        | 
| Rust     | 583.9sec (*)  | avg & peak 100%     | 17GB        | 
| Java     | 209.5sec      | avg 300%, peak 350% | 9GB         | 
| Go       | 169.6sec      | avg 100%, peak 450% | 27GB        |
(*) Rust takes ~30s to output the result, possibly when the cache is deallocated :facepalm:
...
* Java and Go - CPU peaks over 100% - the procedure is single threaded and there's no 
  ...
  * python is also a GC language, however other CPUs aren't used, and this is expected
...
* Memory - Java seems the most effective here, while Go is the most wasteful. This deserves more 
  investigation. Java GC seems the most efficient in reclaiming memory needed and removing what 
